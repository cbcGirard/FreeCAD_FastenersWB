...
# a, b, r, and x are bogus guesstimates for the 'murrican screws
iso2009def={
   ...
   '2-56': (0.4536, 0.8, 25, 4.3688, 4.3688, 0.8128, 0.5842, , 0.3556, 1.0),
   '4-40': (0.6350, 1.0, 25, 5.0, 5.08, 1.0922, 0.7874, , 0.4572, 1.25),
   '6-32': (0.7938, 1.2, 38, 6.35, 6.35, 1.397, 0.9906, , 0.5588, 1.5),
   '8-32': (0.7938, 1.4, 38, 7.5819, 7.5819, 1.6256, 1.143, , 0.6731, 1.75)}
